...
SCRAPY_GOOGLE_SEARCH_PAGE_LIMIT = env(
    "SCRAPY_GOOGLE_SEARCH_PAGE_LIMIT", cast=int, default=5
)
...
# Search backend: "GoogleCustomSearchScrapper" or "SearXNGSearchScrapper"
SCRAPY_SEARCH_BACKEND = env(
    "SCRAPY_SEARCH_BACKEND", cast=str, default="GoogleCustomSearchScrapper"
)
